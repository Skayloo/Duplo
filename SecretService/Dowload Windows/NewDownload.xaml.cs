    ...
    public partial class NewDownload : Window
    {
        ...
        private void btnDownload_Click(object sender, RoutedEventArgs e)
        {
            if (urlValid)
            {
                ...
                {
                    Xceed.Wpf.Toolkit.MessageBox.Show("Имя файла неверно.", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                try
                {
                    ...
                    {
                        string message = "Файл с таким именем уже сущестует. Перезаписать? "
                                       + "Если нет, пожалуйста измените название файла или путь загрузки.";
        ...
        private void btnBrowse_Click(object sender, RoutedEventArgs e)
        {
            ...
            fbDialog.Description = "Выберите папку для загрузки";
        ...
        private void tbDownloadFolder_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            lblFreeSpace.Content = "Свободной памяти: " + GetFreeDiskSpace(drive);
        }
