...
namespace SGet
{
    public partial class MainWindow
    {
        ...
        private void LoadDownloadsFromXml()
        {
            ...
            {
                Xceed.Wpf.Toolkit.MessageBox.Show("Ошибка при загрузке листа загрузок", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void mainWindow_Closing(object sender, CancelEventArgs e)
        {
            ...
            {
                string message = "Вы точно хотите выйти из приложения?";
                MessageBoxResult result = Xceed.Wpf.Toolkit.MessageBox.Show(message, "SecretService", MessageBoxButton.YesNo, MessageBoxImage.Question);
        ...
        private void downloadsGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (downloadsGrid.SelectedItems.Count > 0)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    propertiesList.Add(new PropertyModel(propertyValues[i]));
                }
        ...
        private void UpdatePropertiesList(object sender, PropertyChangedEventArgs e)
        {
            ...
            propertiesList.Add(new PropertyModel(propertyValues[4]));
            propertiesList.Add(new PropertyModel(propertyValues[5]));
        }
        ...
        private void StatusChanged(object sender, EventArgs e)
        {
            ...
            {
                if (completed == 0)
                    this.statusBarActive.Content = " (" + active + " Активно)";
                else
                    this.statusBarActive.Content = " (" + active + " Активно, ";
            }
            else
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            if (downloadsGrid.SelectedItems.Count > 0)
            {
                ...
                {
                    string message = "Вы точно хотите удалить выбранне загрузки?";
        ...
        private void cbShowGrid_Click(object sender, RoutedEventArgs e)
        {
            ...
            cbShowGrid1.IsChecked = cbShowGrid.IsChecked.Value;
            cbShowGrid2.IsChecked = cbShowGrid.IsChecked.Value;
            cbShowGrid3.IsChecked = cbShowGrid.IsChecked.Value;
            cbShowGrid4.IsChecked = cbShowGrid.IsChecked.Value;
            Settings.Default.ShowGrid = cbShowGrid.IsChecked.Value;
            Settings.Default.Save();
        }
        private void cbShowGrid_Click1(object sender, RoutedEventArgs e)
        {
            if (cbShowGrid1.IsChecked.Value)
            {
                this.downloadsGrid.GridLinesVisibility = DataGridGridLinesVisibility.All;
            }
            else
            ...
            cbShowGrid.IsChecked = cbShowGrid1.IsChecked.Value;
            cbShowGrid2.IsChecked = cbShowGrid1.IsChecked.Value;
            cbShowGrid3.IsChecked = cbShowGrid1.IsChecked.Value;
            cbShowGrid4.IsChecked = cbShowGrid1.IsChecked.Value;
            Settings.Default.ShowGrid = cbShowGrid1.IsChecked.Value;
            Settings.Default.Save();
        }

        private void cbShowGrid_Click2(object sender, RoutedEventArgs e)
        {
            if (cbShowGrid2.IsChecked.Value)
            {
                this.downloadsGrid.GridLinesVisibility = DataGridGridLinesVisibility.All;
            }
            else
            ...
            cbShowGrid.IsChecked = cbShowGrid2.IsChecked.Value;
            cbShowGrid1.IsChecked = cbShowGrid2.IsChecked.Value;
            cbShowGrid3.IsChecked = cbShowGrid2.IsChecked.Value;
            cbShowGrid4.IsChecked = cbShowGrid2.IsChecked.Value;
            Settings.Default.ShowGrid = cbShowGrid2.IsChecked.Value;
            Settings.Default.Save();
        }
        private void cbShowGrid_Click3(object sender, RoutedEventArgs e)
        {
            if (cbShowGrid3.IsChecked.Value)
            {
                this.downloadsGrid.GridLinesVisibility = DataGridGridLinesVisibility.All;
            }
            else
            ...
            cbShowGrid.IsChecked = cbShowGrid3.IsChecked.Value;
            cbShowGrid1.IsChecked = cbShowGrid3.IsChecked.Value;
            cbShowGrid2.IsChecked = cbShowGrid3.IsChecked.Value;
            cbShowGrid4.IsChecked = cbShowGrid3.IsChecked.Value;
            Settings.Default.ShowGrid = cbShowGrid3.IsChecked.Value;
            Settings.Default.Save();
        }
        private void cbShowGrid_Click4(object sender, RoutedEventArgs e)
        {
            if (cbShowGrid4.IsChecked.Value)
            {
                this.downloadsGrid.GridLinesVisibility = DataGridGridLinesVisibility.All;
            }
            else
            ...
            cbShowGrid.IsChecked = cbShowGrid4.IsChecked.Value;
            cbShowGrid1.IsChecked = cbShowGrid4.IsChecked.Value;
            cbShowGrid2.IsChecked = cbShowGrid4.IsChecked.Value;
            cbShowGrid3.IsChecked = cbShowGrid4.IsChecked.Value;
            Settings.Default.ShowGrid = cbShowGrid4.IsChecked.Value;
            Settings.Default.Save();
        }
        private void cbShowStatusBar_Click(object sender, RoutedEventArgs e)
        {
            ...
            cbShowStatusBar1.IsChecked = cbShowStatusBar.IsChecked.Value;
            cbShowStatusBar2.IsChecked = cbShowStatusBar.IsChecked.Value;
            cbShowStatusBar3.IsChecked = cbShowStatusBar.IsChecked.Value;
            cbShowStatusBar4.IsChecked = cbShowStatusBar.IsChecked.Value;
            Settings.Default.ShowStatusBar = cbShowStatusBar.IsChecked.Value;
            Settings.Default.Save();
        }
        private void cbShowStatusBar_Click1(object sender, RoutedEventArgs e)
        {
            if (cbShowStatusBar1.IsChecked.Value)
            {
                this.statusBar.Visibility = Visibility.Visible;
            }
            else
            ...
            cbShowStatusBar.IsChecked = cbShowStatusBar1.IsChecked.Value;
            cbShowStatusBar2.IsChecked = cbShowStatusBar1.IsChecked.Value;
            cbShowStatusBar3.IsChecked = cbShowStatusBar1.IsChecked.Value;
            cbShowStatusBar4.IsChecked = cbShowStatusBar1.IsChecked.Value;
            Settings.Default.ShowStatusBar = cbShowStatusBar1.IsChecked.Value;
            Settings.Default.Save();
        }

        private void cbShowStatusBar_Click2(object sender, RoutedEventArgs e)
        {
            if (cbShowStatusBar2.IsChecked.Value)
            {
                this.statusBar.Visibility = Visibility.Visible;
            }
            else
            ...
            cbShowStatusBar1.IsChecked = cbShowStatusBar2.IsChecked.Value;
            cbShowStatusBar.IsChecked = cbShowStatusBar2.IsChecked.Value;
            cbShowStatusBar3.IsChecked = cbShowStatusBar2.IsChecked.Value;
            cbShowStatusBar4.IsChecked = cbShowStatusBar2.IsChecked.Value;
            Settings.Default.ShowStatusBar = cbShowStatusBar2.IsChecked.Value;
            Settings.Default.Save();
        }

        private void cbShowStatusBar_Click3(object sender, RoutedEventArgs e)
        {
            if (cbShowStatusBar3.IsChecked.Value)
            {
                this.statusBar.Visibility = Visibility.Visible;
            }
            else
            ...
            cbShowStatusBar1.IsChecked = cbShowStatusBar3.IsChecked.Value;
            cbShowStatusBar2.IsChecked = cbShowStatusBar3.IsChecked.Value;
            cbShowStatusBar.IsChecked = cbShowStatusBar3.IsChecked.Value;
            cbShowStatusBar4.IsChecked = cbShowStatusBar3.IsChecked.Value;
            Settings.Default.ShowStatusBar = cbShowStatusBar3.IsChecked.Value;
            Settings.Default.Save();
        }

        private void cbShowStatusBar_Click4(object sender, RoutedEventArgs e)
        {
            if (cbShowStatusBar4.IsChecked.Value)
            {
                this.statusBar.Visibility = Visibility.Visible;
            }
            else
            ...
            cbShowStatusBar1.IsChecked = cbShowStatusBar4.IsChecked.Value;
            cbShowStatusBar2.IsChecked = cbShowStatusBar4.IsChecked.Value;
            cbShowStatusBar3.IsChecked = cbShowStatusBar4.IsChecked.Value;
            cbShowStatusBar.IsChecked = cbShowStatusBar4.IsChecked.Value;
            Settings.Default.ShowStatusBar = cbShowStatusBar4.IsChecked.Value;
            Settings.Default.Save();
        }
        ...
        {
            Installation InstallDialog = new Installation(this);
            InstallDialog.ShowDialog();
        }

        private void btnUninstall_Click(object sender, RoutedEventArgs e)
        {
            Uninstall UninstallDialog = new Uninstall(this);
            UninstallDialog.ShowDialog();
        }

        private void btnMD5Check_Click(object sender, RoutedEventArgs e)
        {
            Hash HashDialog = new Hash(this);
        ...
        private void newConfList_Click(object sender, RoutedEventArgs e)
        {
            ConfigList ConfigListDialog = new ConfigList(this);
            ConfigListDialog.ShowDialog();
        }

        private void btnPathVariable_Click(object sender, RoutedEventArgs e)
        {
            PathEdit PathVariableDialog = new PathEdit(this);
            PathVariableDialog.ShowDialog();
        }
        private void rpConfInstall_Click(object sender, RoutedEventArgs e)
        {
            System.Windows.Forms.OpenFileDialog fd = new System.Windows.Forms.OpenFileDialog();
            fd.Title = "Выберите файл конфигурации";
            DialogResult result = fd.ShowDialog();
            string[] path;
            if (result.ToString().Equals("OK"))
            {
                path = File.ReadAllLines(fd.FileName, Encoding.Default);
                Confdownload cnf = new Confdownload();
                for (int i = 0; i < path.Count(); i++)
                {
                    if (path[i].Contains(' '))
                    {
                        string[] ss = path[i].Split(' ');
                        cnf.Donwload_and_install(ss[0], ss[1]);
                    }
                    else
                    {
                        cnf.Donwload_and_install(path[i], null);
                    }
                }
